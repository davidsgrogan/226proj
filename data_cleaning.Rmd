...
If those two numbers don't match then the earlier 1903 filtering isn't appropriate.
...
summarized_postseason_no_na$OPS <- OPS(summarized_postseason_no_na)
nrow(na.omit(summarized_postseason_no_na))
```
...
TODO: Add more columns to postseason and ensure numbers still match.
...
So it's IBB that we don't have data for. Which is unfortunate. SF and CS probably don't matter that much, but I suspect IBB is a fairly unique and informative signal.
